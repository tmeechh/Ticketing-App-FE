      ...
      <div className="bg-white rounded-2xl shadow-xl max-w-lg w-full max-h-[90vh] overflow-y-auto">
        <div className="p-6">
          ...
          <div className="bg-muted/30 rounded-lg p-6 text-center mb-6">
            ...
            <p className="text-sm text-muted-foreground mt-1">{ticket.ticketType} - Qty: {ticket.quantity}</p>
          </div>
          ...
          <div className="flex flex-col space-y-3">
            <div className="flex space-x-3">
              ...
              <Link to={`/events/${ticket.eventId}`} className="btn-primary flex-1 flex items-center justify-center">
            ...
            {activeTab === 'upcoming' && (
              <button 
                ...
                className="btn-destructive flex items-center justify-center"
              >
                Request Refund
              </button>
            )}
