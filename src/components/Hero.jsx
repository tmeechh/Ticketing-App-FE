        ...
        <div className="grid md:grid-cols-2 gap-8 lg:gap-20 items-center">
          <div className="space-y-8">
            <div className="space-y-4">
              <h5 className="text-accent font-medium tracking-wider uppercase animate-fade-in">
              ...
              <p className="text-lg text-white/80 max-w-lg mt-6 animate-slide-up delay-200">
                Discover and book the most exclusive events, concerts, and
                experiences from around the world with EventHorizon's premium
                ticketing platform.
              </p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 animate-slide-up delay-300">
              ...
              <Link
                to="/events"
                className="group flex items-center justify-center sm:justify-start space-x-2 text-white font-medium py-3 px-6"
              >
