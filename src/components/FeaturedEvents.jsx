  ...
  return (
    <section className="section-container">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-12">
        <div>
          <h5 className="text-accent font-medium tracking-wider uppercase mb-2">Featured Events</h5>
      ...
      {isLoading ? (
        ...
        featuredEvents.length > 0 ? (
          ...
          <div className="text-center py-16">
            ...
            <p className="text-muted-foreground mb-6">Check back later for our featured events lineup.</p>
